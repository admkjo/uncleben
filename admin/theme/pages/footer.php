 <!-- BEGIN FOOTER -->
        <div class="page-footer">
            <div class="page-footer-inner"> 2017 &copy; Uncle Ben's Bakery.
            </div>
...
<![endif]-->
        ...
        <script src="../assets/pages/scripts/dashboard_1.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL SCRIPTS -->
        <!-- BEGIN THEME LAYOUT SCRIPTS -->
        <script src="../assets/layouts/layout/scripts/layout.min.js" type="text/javascript"></script>
        <script src="../assets/layouts/layout/scripts/demo.min.js" type="text/javascript"></script>
        <script src="../assets/layouts/global/scripts/quick-sidebar.min.js" type="text/javascript"></script>
        <!-- BEGIN CHARTS PLUGINS -->
        ...
        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>
           <script>
            ...
            var pg = document.getElementById('todaysdate');
//            pg.innerHTML = "Today's Transaction - " + dayarray[day] + ", " + montharray[month] + " " + daym + ", " + year;
            pg.innerHTML = pg.innerHTML + " - "+dayarray[day] + ", " + montharray[month] + " " + daym + ", " + year;
