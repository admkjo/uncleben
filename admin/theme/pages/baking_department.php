                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 yellow-mint" href="#">
                                <div class="visual">
                                    <i class="fa fa-comments"></i>
                                </div>
                                <div class="details">
                                    <div class="number">
                                        <span data-counter="counterup" data-value="34,000">0</span> loaves
                                    </div>
                                    <div class="desc">Received From Moulding and Cutting Department </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 purple-wisteria" href="#">
                                <div class="visual">
                                    <i class="fa fa-bar-chart-o"></i>
                                </div>
                                <div class="details">
                                    <div class="number">
                                        <span data-counter="counterup" data-value="33,500">0</span>  Loaves </div>
                                    <div class="desc"> Sent To Sales Department </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 blue-chambray" href="#">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <span data-counter="counterup" data-value="49">10</span>  Loaves
                                    </div>
                                    <div class="desc">Got burnt </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 blue-chambray" href="#">
                                ...
                                <div class="details">
                                    <div class="number"> 
                                        <span data-counter="counterup" data-value="20"></span>  Loaves</div>
                                    <div class="desc"> Returned To Moulding and Cutting Department </div>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="portlet box default">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Input Received From Moulding and Cutting Department</div>
                                    <div class="actions">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="portlet box red-haze">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Quantity Returned To Moulding and Cutting Department  </div>
                                    <div class="actions">
                                        <a href="javascript:;" class="">
                                            <i></i></a>
                                        <a href="javascript:;" class="btn btn-default btn-sm">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Output Generated For Sales Department </div>
                                    <div class="actions">
                                        <a href="javascript:;" class="">
                                            <i></i></a>
                                        <a href="javascript:;" class="btn btn-default btn-sm">
