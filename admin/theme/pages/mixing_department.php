                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 blue" href="#">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc">Received From Measuring Room </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 red" href="#">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <span data-counter="counterup" data-value="800">0</span> Kg </div>
                                    <div class="desc"> Sent To Moulding and Cutting Department </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 green" href="#">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <span data-counter="counterup" data-value="549">0</span> Kg
                                    </div>
                                    <div class="desc"> Returned from Moulding and Cutting Department </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 purple" href="#">
                                ...
                                <div class="details">
                                    <div class="number"> 
                                        <span data-counter="counterup" data-value="89"></span> Kg</div>
                                    <div class="desc"> Returned To Measuring room </div>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="portlet box red-haze">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Input Received From Measuring Room </div>
                                    <div class="actions">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="portlet box red-haze">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Quantity Returned To Measuring Room  </div>
                                    <div class="actions">
                                        <a href="javascript:;" class="">
                                            <i></i></a>
                                        <a href="javascript:;" class="btn btn-default btn-sm">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Output Generated For Moulding and cutting Department </div>
                                    <div class="actions">
                                        <a href="javascript:;" class="">
                                            <i></i></a>
                                        <a href="javascript:;" class="btn btn-default btn-sm">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="portlet box  blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Quantity Returned From Moulding And Cutting Department </div>
                                    <div class="actions">
                                        <a href="javascript:;" class="">
                                            <i></i>  </a>
                                        <a href="javascript:;" class="btn btn-default btn-sm">
