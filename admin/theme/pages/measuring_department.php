                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span>Measuring Department</span>
                            </li>
                        </ul>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 yellow-crusta" href="#">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc">Received From Inventory </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 dark" href="#">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> Sent To Mixing Department </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 green" href="#">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> Returned from Mixing Department </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 purple" href="#">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> Returned To Inventory </div>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="portlet box yellow-casablanca">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Input Received From Inventory </div>
                                    <div class="actions">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="portlet box purple">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Quantity Returned To Inventory  </div>
                                    <div class="actions">
                                        <a href="javascript:;" class="">
                                            <i></i></a>
                                        <a href="javascript:;" class="btn btn-default btn-sm">
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Output Generated For Mixing Department </div>
                                    <div class="actions">
                                        <a href="javascript:;" class="">
                                            <i></i></a>
                                        <a href="javascript:;" class="btn btn-default btn-sm">
